...
- **`examples/`** — worked examples showing the full chain from intent to compiled prompt: [`train-platform-shot.md`](examples/train-platform-shot.md) (a single shot spec end to end) and [`color-grading-genre-lookbook.md`](examples/color-grading-genre-lookbook.md) (§42 genre heuristics applied as six bright/dark-tested show looks)
